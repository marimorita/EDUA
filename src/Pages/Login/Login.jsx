  ...
  return (
    <div className={`${loginClass}bg-white h-full w-[90%] items-center relative pt-32`}>
      <div className='bg-white flex justify-center flex-col space-y-3 '>
        ...
        <button onClick={handleButtonClickPassword} className='text-[#484646] font-semibold flex text-start text-[13px]'>He olvidado mi contraseña</button>
        <Buttons btnStyle={"mt-5 bg-[#D9D9D9]"} label="Iniciar sesión" buttonEvent={verification}/>
