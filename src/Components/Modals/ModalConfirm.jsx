...
export const ModalConfirm = ({ visibility, message, redirectPathCancel, handleButtonClickConfirm }) => {
  const [, setLocation] = useLocation();
  const { viewConfirmModal, setViewConfirmModal, setValueRol } = useContext(StateContext)
